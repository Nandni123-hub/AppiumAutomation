...
public class EcomTC_3_Hybrid extends BaseClassTest {
...
//        driver.findElement(By.id("com.androidsample.generalstore:id/appbar_btn_cart")).click();
        ...
        for(String contextName:contexts) {
            System.out.println(contextName);// to get context name
        }

        driver.context("WEBVIEW_com.androidsample.generalstore");// give path of chrome driver and find right chrome driver version
